 ...
 * Use the {@link vb#newInstance} factory method to
...
public class vb extends Fragment {
     ...
     * @return A new instance of fragment vb.
     */
    // TODO: Rename and change types and number of parameters
    public static vb newInstance(String param1, String param2) {
        vb fragment = new vb();
    ...
    {
        Query qury = reference.orderByChild("coursename").equalTo("VB.net");
